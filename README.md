...
<p align="center">
 ...
 Dependencies Build Coverage Gitter  Contributors LICENCE

What is collate-for-me?
collate-for-me is a platform where humans (and bots) from all branches of software development can join hands to build a dashboard of your choice, served on your computer and is not influenced by the marketting algorithms of big tech corporates.
...
sha256sum since 8.21
Contributing
We expect contributors to abide by our underlying code of conduct. All conversations and discussions on GitHub (issues, pull requests) and across collate-for-me must be respectful and harassment-free.

Where to contribute
When in doubt, ask a core team member! You can mention us in any issues or ask on the DEV Contributor thread. Any issue with good first issue tag is typically a good place to start.
...
Any questions, please refer to our license FAQ doc or email mail@collate-for-me.com
